...
figure()
plot(rho,'o-')
# plot(range(1,len(rho)+1),np.cumsum(rho),'o-') #juste pour vérifier l'histoire des 22 composantes
# plot([22,22],[0,1])
...
#2-2-3 reconstruction is better when K is higher. How many components ? around 5 to 10 ins enough
